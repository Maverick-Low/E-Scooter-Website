...
class CorrectPayment():
    def __init__(self, country=None, name="Jane Doe", card_number="123456789101112", cvv=230, expiry_date=datetime.now() + timedelta(weeks=1), address_line_1="Flat 3 Birch House", city="London", postcode="HA39TE", follow_redirects=True):
        self.name = name
    ...
    def test_booking_scooter_correct_1(self):
        ...
        with app.test_client() as c:
            with c.session_transaction() as sess:
                sess['email'] = 'session_email@email.com'
                sess['admin'] = 0
            payment = CorrectPayment(cvv=00000)                
